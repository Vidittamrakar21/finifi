Got it. Since you don't need any additional data or changes, here is the finalized `README.md` text. You can copy this directly into your project.

***

# 📦 Three-Way Match Engine

A specialized backend service built to automate the reconciliation of procurement documents (PO, GRN, and Invoices). This system leverages the **Gemini 1.5 Flash API** for intelligent data extraction and **MongoDB** for persistent storage and matching.
...
* **AI Extraction**: The PDF is sent to the **Gemini 1.5 Flash** model. A strict prompt ensures the AI returns a clean JSON object containing headers (PO numbers, dates) and line items.
...
* **Trade-off**: Used `gemini-1.5-flash` for its speed and high-quality OCR, which is essential for processing table-heavy documents.
